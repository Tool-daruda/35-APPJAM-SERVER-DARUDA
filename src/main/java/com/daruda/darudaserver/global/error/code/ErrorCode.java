...
public enum ErrorCode {
	...
	INVALID_IMAGE_TYPE(HttpStatus.BAD_REQUEST, "E400006", "지원하지 않는 이미지 확장자 입니다."),
	DATA_INTEGRITY_VIOLATION(HttpStatus.BAD_REQUEST, "E400007", "데이터 무결성 제약 조건을 위반했습니다"),
	INVALID_TOOL_CATEGORY(HttpStatus.BAD_REQUEST, "E400008", "존재하지 않는 카테고리 입니다."),
	...
	INVALID_PAGE_MIN_SIZE(HttpStatus.BAD_REQUEST, "E400015", "페이지는 1 이상이어야 합니다."),
