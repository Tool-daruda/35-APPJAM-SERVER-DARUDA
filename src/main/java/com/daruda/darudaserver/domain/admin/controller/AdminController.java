...
public class AdminController {
	...
	@Operation(
		...
		description = """
			...
			**플랜 케이스 예시:**
			1. 무료 툴: planType="무료", plans=[] 또는 plans=[{planName:"무료", planPrice:0, planDescription:"기본 기능 무료 제공"}]
			2. 월간 구독: planType="월간", plans=[{planName:"Basic", planPrice:10000, ...}, {planName:"Pro", planPrice:30000, ...}]
			3. 일회성 구매: planType="구매", plans=[{planName:"Starter", planPrice:50000, ...}, {planName:"Professional", planPrice:150000, ...}]
			4. 혼합: planType="월간 & 연간", plans=[{planName:"Basic 월간", planPrice:10000, ...}, {planName:"Basic 연간", planPrice:100000, ...}]
