...
public record BoardCreateAndUpdateRequest(
        ...
        public static BoardCreateAndUpdateRequest of(String title, String content, Long toolId, List<MultipartFile> images) {
                return BoardCreateAndUpdateRequest.builder()
                        .title(title)
                        .content(content)
                        .toolId(toolId)
                        .images(images)
